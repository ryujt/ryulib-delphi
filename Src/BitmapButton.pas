...
var
  Loop, iWidth, iHeight, BitmapIndex: Integer;
begin
  inherited;
  ...
  iWidth  := Canvas.TextWidth(Caption);
  iHeight := Canvas.TextHeight(Caption);
  Canvas.TextOut( (Width - iWidth) div 2, (Height - iHeight) div 2, Caption);
end;
